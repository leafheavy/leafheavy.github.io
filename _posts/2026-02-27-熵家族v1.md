...
由上, 笔者希望更系统地理解信息熵, 互信息; 并将自己的学习笔记汇总整理如下. 主要学习资料来自于苏剑林的[科学空间](https://spaces.ac.cn/). 苏神的博客质量非常高, 是非常好的学习材料. 下述笔记的逻辑模仿苏神博客内容的组织方式.
...
*Common Expression 1:* $S(Y\mid X)=-\sum_x \sum_y p(x, y) \log p(y\mid x)$.
...
\end{align}
$$
*Common Expression 2:* $S(Y\mid X)=-\sum_x p(x) \sum_y p(y\mid x) \log p(y\mid x)$.
...
考虑到篇幅过长, 新开一篇博客记录. 详情请见 "熵家族 v2" 博客.

---

> # Reference
>
> [1] [“熵”不起: 从熵、最大熵原理到最大熵模型（一）](https://spaces.ac.cn/archives/3534)
>
